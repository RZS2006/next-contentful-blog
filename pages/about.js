		...
		<>
			...
			<div className="wrapper py-6">
				...
				<p className="lg:w-1/2 leading-8">
					...
					<em>traktorimönkijä</em> had a short but eventful life. Rest in
					peace. The recycled metal will be put into good use. Let us hope
					that the <em>mopoauto</em> will last longer.
				</p>
			</div>
		</>
	);
